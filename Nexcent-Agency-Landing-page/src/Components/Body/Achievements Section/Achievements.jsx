...
const Achievements = () => {
  ...
  return (
    <div className="flex px-36 py-16 gap-x-10 bg-[#F5F7FA] mb-12">
        <div className="section-heading flex flex-col gap-y-2 basis-1/2">
            ...
            <div className="counts border-2 flex flex-col gap-6 p-4 basis-1/2 items-start">
                    ...
                    <div className="members flex gap-x-2">
                        ...
                        <div className="number-label">
                            <span className="text-2xl font-semibold">
                                {counterState && <CountUp start={0} end={2245341}></CountUp>}
                                </span>
                            <p className="text-neutralGray text-sm">Members</p>
                        </div>
                    </div>
                    <div className="clubs flex gap-x-4 ">
                        <div className="icon">
                            <img src={icon7} alt="" />
                        </div>
                        <div className="number-label">
                ...
                <div className="rows-2 flex justify-around">
                    <div className="event-bookings flex gap-x-2">
                        ...
                        <div className="number-label">
                            <span className="text-2xl font-semibold">
                                {counterState && <CountUp start={0} end={828867} duration={2.75}></CountUp>}
                                </span>
                    ...
                    <div className="payments flex gap-x-2">
                        ...
                        <div className="number-label">
                            <span className="text-2xl font-semibold">
                                {counterState && <CountUp start={0} end={1926436} duration={3.2}></CountUp>}
                                </span>
